...
<html>
<head>
<title>Edit <fmt:message key="forum.title"/> <fmt:message key="topic.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveForumTopics" method="POST" modelAttribute="topic">
