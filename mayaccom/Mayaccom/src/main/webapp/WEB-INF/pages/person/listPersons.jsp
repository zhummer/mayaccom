		...
		<table id="listTable" cellpadding="0" cellspacing="0">
			<thead>
				<tr>
					...
					<th class="thead"><fmt:message key="person.email.title"/></th>
					<th class="thead"><fmt:message key="person.address.title"/></th>
					<th class="thead"><fmt:message key="person.city.title"/></th>
					<th class="thead"><fmt:message key="person.password.title"/></th>
					<th class="thead"><fmt:message key="person.dtype.title"/></th>
				</tr>
			</thead>
			<tbody>
