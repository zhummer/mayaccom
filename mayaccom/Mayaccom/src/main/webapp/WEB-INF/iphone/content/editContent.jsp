...
<html>
<head>
<title>Edit <fmt:message key="content.title"/></title>
</head>
<body>
...
<div id="content">
<form:form name="editform" action="${pageContext.request.contextPath}/saveContent" method="POST" modelAttribute="content">
