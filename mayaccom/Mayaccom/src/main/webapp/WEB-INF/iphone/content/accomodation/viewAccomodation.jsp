...
<html>
<head>
<title>View <fmt:message key="content.title"/> <fmt:message key="accomodation.title" /></title>
</head>
<body>
<div id="topbar">
	<div id="title"><fmt:message key="accomodation.title"/></div>
	<div id="leftnav"><a href="${pageContext.request.contextPath}/selectContent?idKey=${content_id}&"><fmt:message key="navigation.back"/></a></div>
	<div id="rightbutton"><a href="${pageContext.request.contextPath}/editContentAccomodation?content_id=${content_id}&accomodation_id=${accomodation.id}&"><fmt:message key="navigation.edit"/></a></div>
</div>
<div id="content">
	...
	<a href="${pageContext.request.contextPath}/deleteContentAccomodation?content_id=${content_id}&related_accomodation_id=${accomodation.id}&" class="bigButton red"><fmt:message key="navigation.delete"/></a>
</div>
</body>
</html>
