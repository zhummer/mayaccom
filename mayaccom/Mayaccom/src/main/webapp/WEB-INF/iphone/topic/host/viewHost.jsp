...
<html>
<head>
<title>View <fmt:message key="topic.title"/> <fmt:message key="host.title" /></title>
</head>
<body>
<div id="topbar">
	...
	<div id="rightbutton"><a href="${pageContext.request.contextPath}/editTopicHost?topic_id=${topic_id}&host_id=${host.id}&"><fmt:message key="navigation.edit"/></a></div>
</div>
<div id="content">
	...
	<a href="${pageContext.request.contextPath}/deleteTopicHost?topic_id=${topic_id}&related_host_id=${host.id}&" class="bigButton red"><fmt:message key="navigation.delete"/></a>
</div>
</body>
</html>
