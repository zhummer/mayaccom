...
<html>
<head>
<title>Edit <fmt:message key="topic.title"/> <fmt:message key="post.title" /></title>
</head>
<body>
...
<form:form name="editform" action="${pageContext.request.contextPath}/saveTopicPosts" method="POST" modelAttribute="post">
