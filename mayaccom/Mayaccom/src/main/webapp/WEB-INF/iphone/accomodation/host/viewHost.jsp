...
<div id="topbar">
	...
	<div id="leftnav"><a href="${pageContext.request.contextPath}/selectAccomodation?idKey=${accomodation_id}&"><fmt:message key="navigation.back"/></a></div>
	<div id="rightbutton"><a href="${pageContext.request.contextPath}/editAccomodationHost?accomodation_id=${accomodation_id}&host_id=${host.id}&"><fmt:message key="navigation.edit"/></a></div>
</div>
<div id="content">
	...
	<a href="${pageContext.request.contextPath}/deleteAccomodationHost?accomodation_id=${accomodation_id}&related_host_id=${host.id}&" class="bigButton red"><fmt:message key="navigation.delete"/></a>
</div>
</body>
</html>
