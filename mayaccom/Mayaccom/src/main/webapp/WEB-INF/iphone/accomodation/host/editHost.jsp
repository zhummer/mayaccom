...
<html>
<head>
<title>Edit <fmt:message key="accomodation.title"/> <fmt:message key="host.title" /></title>
</head>
<body>
...
<form:form name="editform" action="${pageContext.request.contextPath}/saveAccomodationHost" method="POST" modelAttribute="host">
