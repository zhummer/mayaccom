...
<html>
<head>
<title>Edit <fmt:message key="host.title"/> <fmt:message key="accomodation.title" /></title>
</head>
<body>
...
<form:form name="editform" action="${pageContext.request.contextPath}/saveHostAccomodations" method="POST" modelAttribute="accomodation">
