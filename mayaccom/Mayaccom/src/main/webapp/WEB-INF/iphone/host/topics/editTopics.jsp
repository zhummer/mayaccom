...
<html>
<head>
<title>Edit <fmt:message key="host.title"/> <fmt:message key="topic.title" /></title>
</head>
<body>
...
<form:form name="editform" action="${pageContext.request.contextPath}/saveHostTopics" method="POST" modelAttribute="topic">
